...
CREATE TABLE `tblreview` (
  ...
  CONSTRAINT `fk_tblreview_tblmovie` FOREIGN KEY (`movie_id`) REFERENCES `tblmovie` (`movie_id`),
  CONSTRAINT `fk_tblreview_tblreviewer` FOREIGN KEY (`reviewer_id`) REFERENCES `tblreviewer` (`reviewer_id`),
